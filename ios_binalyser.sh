...
keywords_grep=$(cat "$output_dir"/strings_5.txt | grep -E -i -e "admin" -e "administrator" -e "password" -e "pw" -e "user" -e "uname" -e "username" -e "usr" -e "select" -e "create" -e "table" -e "insert" -e "delete" -e "alter" -e "modify" -e "hostname" -e "host" -e "credentials" -e "key" -e "mysql" -e "database" -e "sqlite" -e "connection_string" -e "[0-9\.]{3}[0-9]" > "$output_dir"/strings_keywords.txt)
